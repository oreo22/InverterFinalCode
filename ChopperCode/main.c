...
uint32_t test_case[24]={40,40,40,40,100,500,1000,1161,1273,1375,1546,1714,1980,1980,1980,1980,1980,1980,1768,1732,1000,500,100,40};

	
	
uint32_t test2[24]=	{ 1028 , 1112 , 1196 , 1280 , 20 , 20 , 20 , 40 , 40 , 1364 , 1448 , 1532 , 1112 , 1196 , 1980 , 1980 , 1980 , 1980 , 1980 , 1980 , 1280 , 1364 , 1448 , 1196 };
...
uint32_t summer_duty[24] = {1101,1039,1006,1055,1131,1187,1292,1387,40,40,40,40,40,1779,1812,1829,1846,1812,1761,1672,1557,1432,1267,1160};
...
void Timer_15s_Init(void){
    ...
    NVIC_ST_RELOAD_R = 800000; //5333;//1000000; //5333;//10000000;      // reload value (will interupt once a second for 80Mhz clock) 0x04C4B400
	...
	*/
	...
	while(1){
		...
		if (flag){ 
			flag = 0;
			index = (index +1)%24;
			PWM0A_Duty(test_case[index]);
			uint32_t inverse=2000-test_case[index];
			PWM0B_Duty(inverse);
		
		//	PWM0A_Duty(1000); //inverse of 1500/2000
		//	PWM0B_Duty(1000); //aactually gonna give you 1500/2000
